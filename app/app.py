...
IMAGE_FROM_ENV = os.environ.get('IMAGE') or str("https://github.com/ansible/instruqt/blob/main/assets/ansible-demo.png?raw=true")
...
def main():
    # return 'Hello'
    return render_template('hello.html', name=socket.gethostname(), color=color_codes[COLOR], pusher=PUSHER_FROM_ENV, gitref=GITREF_FROM_ENV)
